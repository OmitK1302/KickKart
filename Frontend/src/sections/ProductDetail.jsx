...
const ProductDetail = ({product}) => {
    ...
    const addToCartHandler = () => {
        dispatch(addToCart({...product, qty, size})); // Dispatch the addToCart action with the product, quantity, and size as the payload.
                    ...
                    { (product.stock <= 0) ? 
                        ...
                        <>
                            ...
                            <form className='mt-4 mb-4 flex'>
                                ...
                                <div className='mt-4 mb-4 flex'>
                                    <label className='flex justify-between items-center p-4'>
                                        <h2 className='text-l font-semibold font-montserrat'>Size: </h2>
                                    </label>
                                    <select className='bg-gray-200 hover:bg-gray-300 rounded-md p-4' name='size' id='size' value={size} onChange={handleSizeChange}>
