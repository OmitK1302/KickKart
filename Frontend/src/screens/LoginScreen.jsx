...
import { account, key } from '../assets/icons';
...
const LoginScreen = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            toast.success("Login successful!"); // This should appear on success
            navigate(redirect);
        } catch (err) {
        ...
        <div className='w-full px-4 py-24 sm:pt-28 flex justify-center items-center font-montserrat'>
            <div className='w-96 p-12 border-x-2 mt-16'>
                ...
                <form className='flex flex-col gap-4' onSubmit={submitHandler}>
                    ...
                    <button type='submit' className='border-2 rounded-md bg-coral-red text-white p-4 cursor-pointer hover:bg-[#f05d4d] font-bold text-xl' disabled={isLoading}>
                        Login
                    </button>
                ...
                <div className='p-2 mt-4'>
                    <p>New Custome? <span className='text-coral-red font-bold underline'><Link to={redirect ? `/register?redirect=${redirect}` : '/register'}>Register</Link></span></p>
                </div>
