            ...
            <div className='sm:px-8 flex xl:flex-row flex-col gap-4 w-full'>
                <div className='py-6 px-0 sm:py-8 mt-4 border-2 shadow-inner rounded-md xl:w-1/2'>
                    ...
                    {cart.cartItems.length === 0 ? (
                        ...
                        <div className='padding'>
                            <Message color="blue" value="No Items to Order" />
                        </div>
                    ) : (
                        <>
                ...
                <div className='sm:px-16 px-4 pt-4 py-16 sm:py-8 mt-4 border-2 shadow-xl xl:w-1/2'>
                    ...
                    <div className='px-8 pt-2 pb-8 text-xl'>
                        ...
                        <div className='flex justify-end p-2 mt-8'>
                            <button className={`border-2 p-4 rounded-full font-semibold ${cart.cartItems.length === 0 ? "border-gray-400 text-gray-400 cursor-not-allowed" : "hover:bg-coral-red hover:text-white border-coral-red "} `} onClick={placeOrderHandler} disabled={cart.cartItems.length === 0}>
                                Place Order
                            </button>
                        </div>
