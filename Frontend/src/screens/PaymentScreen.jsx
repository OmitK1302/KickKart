...
import { paypalLogo } from '../assets/icons'
    ...
    <div className='padding'>
        ...
        <div className='w-full flex justify-center items-center font-montserrat'>
          ...
          <h1 className='text-3xl mb-4 font-bold text-coral-red'>Payment Method </h1>
            <form className='ml-4 flex flex-col' onSubmit={(e) => submitHandler(e)}>
              <div className='border-2 w-64 p-2 rounded-lg'>
                <label className='flex border-'>
                  <input type='radio' name='paymentMethod' value='PayPal' checked className='mr-4' onChange={(e) => setPaymentMethod(e.target.value)}/>
